...
export default class DayNightLive extends React.Component {
  ...
  handleUpdate(newData) {
    ...
    const updatedProps = {
      ...
      initialAmbientLight: newData.initialAmbientLight,
      autoCycle: newData.autoCycle
    }

    if (GAME.gameState.ambientLight !== newData.initialAmbientLight) {
      if (PAGE.role.isHost) {
  ...
  render() {
    ...
    return (
      <div className='DayNightLive'>
        <div>
          <DatGui style={{ marginTop: '400px' }} data={{ ambientLight }} onUpdate={this.handleLightUpdate}>
