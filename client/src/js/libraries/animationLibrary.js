global.local.on('onFirstPageGameLoaded', () => {
  global.particleEmitterLibrary = {
    ...
    editObject:{"alpha":{"start":0.3,"end":0.3},"scale":{"start":1.7,"end":1.6,"minimumScaleMultiplier":1.1},"color":{"start":"#ffffff","end":"#ffffff"},"speed":{"start":150,"end":125,"minimumSpeedMultiplier":0.4},"acceleration":{"x":0,"y":0},"maxSpeed":0,"startRotation":{"min":0,"max":360},"noRotation":false,"rotationSpeed":{"min":0,"max":0},"lifetime":{"min":1000,"max":1000},"blendMode":"normal","ease":[{"s":0,"cp":0.329,"e":0.548},{"s":0.548,"cp":0.767,"e":0.876},{"s":0.876,"cp":0.985,"e":1}],"frequency":0.001,"emitterLifetime":10,"maxParticles":12,"pos":{"x":0,"y":0},"addAtBack":true,"spawnType":"point","useUpdateOwnerPos":true,"persistAfterRemoved":true,"matchObjectColor":true,"type":"editobject1","speedType":"fast","spawnWaitTime":100,"useOwnerSprite":true,"animationType":"particle"}
  }
