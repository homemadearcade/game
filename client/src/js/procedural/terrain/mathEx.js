...
*/
exports.scale = function(n, a, b, c, d) {
...
*/
exports.vectorize = function(x1, y1, x2, y2) {
	return {
		x: x2 - x1,
		y: y2 - y1
	}
...
*/
exports.normalizeVector = function(vector) {
...
*/
exports.lerpColor = function(colorA, colorB, portion) {
    return {
