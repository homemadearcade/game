    ...
    if(isStarted) {
      ...
      playIcons= <React.Fragment>
        <i
          ...
          onClick={(e) => {
            global.socket.emit('stopSequence', id, HERO.editingId)
            e.stopPropagation()
            this.setState({
              isPaused: false,
              isStarted: false,
        ...
        <i
          ...
          onClick={(e) => {
            global.socket.emit('togglePauseSequence', id, HERO.editingId)
            e.stopPropagation()
            this.setState({
      ...
      playIcons= <i
        ...
        onClick={(e) => {
          global.socket.emit('startSequence', id, HERO.editingId)
          e.stopPropagation()
          this.setState({
            isStarted: true
          })
